...
Olive **never** executes destructive permanent deletions (`rm -rf`) by default.
...
Olive maintains a hardcoded exclusion list that can **never** be modified or targeted for deletion:
...
3. **Audit Logging**: All moved items are logged locally to `~/Library/Logs/Olive/operations.log` with timestamps and original source paths.
...
- Olive never prompts for passwords in insecure plain-text inputs.

---

## 4. Reporting Security Issues

If you discover a security vulnerability in Olive:
